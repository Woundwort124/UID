...
typedef struct {
	...
	uint32_t FSMC_DataSetupTime; /* Defines the number of HCLK cycles to configure
					...
					@note: It is used for SRAMs, ROMs and asynchronous multiplexed NOR Flash
					memories. */
...
typedef struct {
	...
	FSMC_NORSRAMTimingInitTypeDef *FSMC_ReadWriteTimingStruct; /* Timing Parameters for write and read access if the
